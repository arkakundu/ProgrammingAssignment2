...
## We can run the codes in R and then use the following lines to test the code
## > a<-matrix(data=1:4,nrow=2,ncol=2)
## > z<-makeCacheMatrix(a)
## > cacheSolve(z)


## The first function, makeCacheMatrix returns a list containing a 
## function to set the value of the matrix, get the value of the matrix, 
## set the value of the inverse of the matrix and and get the value of the 
## inverse
